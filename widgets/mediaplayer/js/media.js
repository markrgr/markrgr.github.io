...
$(document).ready(function () {
    ...
    if (!style) {
        ...
        if (styleString == '"bubble"') {
            var vidString = '';
            vidString += '<div class="vid bubble bubble16x9"><div class="videoBox"><video id="video1" data-dashjs-player="" src="https://media.reallygreatreading.com/object-link/' + vid + '/raw.mpd" crossorigin="anonymous" autoplay>';
            vidString += '<track default kind="captions" srclang="en" src="https://media.reallygreatreading.com/object-link/' + vid + '/en.vtt" />';
