        ...
        switch (data[o].type) {
            case 'sld':
                ...
                if (data[o].action == 'closeParent') {
                   // htmlString += '<div role="button" alt="close" aria-label="close" name="close" class="btnClose" tabindex="' + tabIndex + '" tabindexfixed="' + tabIndex + '"><div class="btnCloseFocus"></div><div class="btnCloseBack" role="button" alt="close" aria-label="close" name="close"></div></div>';
                    htmlString += '<div role="button" alt="close" aria-label="close" name="close" class="btnClose" tabindex="0" tabindexfixed="' + tabIndex + '"><div class="btnCloseFocus"></div><div class="btnCloseBack" role="button" alt="close" aria-label="close" name="close"></div></div>';
            ...
            case 'icn':
                ...
                if (data[o].role == 'button') {
                    tabIndex++;
                    //htmlString += '" tabindex="' + tabIndex + '"';
                    htmlString += '" tabindex="0"';

                    htmlString += '" tabindexFixed="' + tabIndex + '"';
                }
...
function buildObjects(data) {
    ...
    $('.icn[action="openGroupGhost"]').bind('click', function () {
        ...
        $('.grpGhost').fadeIn(300);
        $('.vidBox').fadeIn(300);
        $('#video1Slider').fadeIn(300);
        $('#wrapper .icn').removeAttr('tabindex');
        $('#wrapper .btnClose').removeAttr('tabindex');
        $('.slider').focus();
        initSDWVideo($(this).attr('vlink'));
    });
    ...
    $('.btn[action="closeGroupGhost"]').bind('click', function () {
        ...
        $('.vidBox').fadeOut(200);
        $('#video1Slider').fadeOut(100);
        var video = $('#video1').get(0);
        video.pause();
        $('#video1Slider').removeClass('playing');
        $('[tabindexfixed]').each(function () {
            // Get the value of the 'tabindexfixed' attribute
            var fixedTabIndex = $(this).attr('tabindexfixed');

            // Set the 'tabindex' attribute to the value of 'tabindexfixed'
            $(this).attr('tabindex', fixedTabIndex);

            // Optionally, remove the 'tabindexfixed' attribute if you no longer need it
            // $(this).removeAttr('tabindexfixed');
        });
