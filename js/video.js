function addVideo(videoID) {
    $('#widgets').html('<iframe class="vidFrame" src=widgets/mediaplayer/index.html?vid=' + videoID + ' aria-label="streaming video frame"></iframe><div class="vidClose" tabindex="0" aria-label="close video bubble" role="button"></div>');
    $('#widgets').fadeIn(500);
