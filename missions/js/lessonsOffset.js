...
function initPage(curPage, template) {
    ...
    switch (template) {
        ...
        case "VI001":
            ...
            htmlString += '<source src="' + oggVideo + '" type="video/ogg">';
            htmlString += '</video>';
            htmlString += '<div id="VI001Next" class="nextButton">next</div>';
            htmlString += '<div class="videoCopyright">&copy;2018 Really Great Reading. All Rights Reserved.</div>';
...
case "l4bv1":
       ...
       case "l0cv0":
        ...
        case "SB013":
            ...
            $('#SB013Boards span').css('transition', 'all .5s 0s');
            setUpStep('SB013()');
            break;
        case "SB014":
            var parseText = lessonData.pages[pageNum].words[0];
        ...
        case "WS020":
            ...
            htmlString += '<td class="syllablesTableCellSpacer">&nbsp;</td>';
            htmlString += '<td class="syllablesTableText" colspan="' + lessonData.pages[pageNum].circles + '"><div id="WS020Title1" class="syllablesTableTextHeader">how many<br />syllables?</div></td>';
